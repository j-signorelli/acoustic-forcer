...
$$
\rho=0.1729+\dfrac{1}{15625}10\cos\left(\frac{16\pi}{7} x + \frac{\pi}{3} - 2000\pi t\right)
$$
$$
...
The flow solution for this is exactly:
$$
\rho=0.1729+\dfrac{1}{15625}\left[10\cos\left(\frac{16\pi}{7} x + \frac{\pi}{3} - 2000\pi t\right)+5\cos\left(\frac{20\pi}{9} x + \pi - 2500\pi t\right)\right]
$$
$$
